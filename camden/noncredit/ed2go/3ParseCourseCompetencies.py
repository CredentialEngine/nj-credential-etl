...
html_dir = r"C:\text\NJ\Camden\noncredit\ed2go\coursesHTMLCourse"

# Output CSV file paths
courses_csv_path = r"C:\text\NJ\Camden\noncredit\ed2go\Camden_BU_Noncredit_ed2go_Courses.csv"
competencies_csv_path = r"C:\text\NJ\Camden\noncredit\ed2go\Camden_BU_Noncredit_ed2go_Course_Competencies.csv"
...
courses_headers = [
    ...
    "Coded Notation", "Teaches Competency Framework", "Is Non-Credit", "Keywords", "Cost: External Identifier", "Cost: Currency Type", "Cost: Types List",
        ...
        if os.path.isfile(file_path) and html_file.endswith(".html"):
            with open(file_path, 'r', encoding='utf-8') as file:
                ...
                course_row = {
                    ...
                    "Financial Assistance: Subject Webpage": "https://careertraining.ed2go.com/camdencc/financial-assistance/",
                    ...
                    "Learning Method Type": "SelfPaced"
                }
