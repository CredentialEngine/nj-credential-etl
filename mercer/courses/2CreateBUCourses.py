...
input_file = r"C:\text\NJ\Mercer\courses\all_courses.csv"  # Change to your actual file path
...
for _, row in df.iterrows():
    ...
    in_catalog = f"https://catalog.mccc.edu/courses/{linkcourseGroupId}" if pd.notna(row["courseGroupId"]) else "N/A"
...
# Save to CSV
output_file = "Mercer_BU_Credit_Courses.csv"
