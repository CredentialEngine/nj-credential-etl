...
def main():
    ...
    #https://app.coursedog.com/api/v1/cm/mercercounty_colleague/programs/search/%24filters?catalogId=uactPpmWkUJ3jsgXArnH&skip=0&limit=20&sortBy=catalogDisplayName%2CtranscriptDescription%2ClongName%2Cname&effectiveDatesRange=2024-09-03%2C2025-08-20&columns=name%2Ctype%2CdegreeDesignation%2Ccontacts%2ClongName%2CcatalogDisplayName%2CtranscriptDescription%2CcatalogDescription%2CcatalogImageUrl%2CcipCode%2Ccampus%2Clevel
    url_template = (
        "https://app.coursedog.com/api/v1/cm/mercercounty_colleague/programs/search/%24filters"
