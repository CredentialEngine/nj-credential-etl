...
OUTPUT_JSON = Path("brookdale_courses_all.json")
OUTPUT_CSV = Path("brookdale_courses_all.csv")
CHECKPOINT_FILE = Path("brookdale_checkpoint.json")
...
def build_session() -> requests.Session:
    ...
    session.headers.update({
        ...
        "Origin": "https://catalog.brookdalecc.edu",
        "Referer": "https://catalog.brookdalecc.edu/",
        "User-Agent": (
