...
def main():
    csv_file = r"C:\text\NJ\Brookdale\credentials\all_data.csv"
    output_folder = r"C:\text\NJ\Brookdale\credentials\CredentialHTML"
    ...
    with open(csv_file, newline='', encoding='utf-8') as f:
        ...
        for row in reader:
            ...
            # Construct the URL
            url = f"https://catalog.brookdalecc.edu/programs/{code}"
