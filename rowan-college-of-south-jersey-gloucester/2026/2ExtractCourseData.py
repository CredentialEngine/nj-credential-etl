...
PDF_DIR = Path(r"C:\text\NJ\Rowan College of South Jersey - Gloucester\2026\pdfs")
OUT_CSV = Path(r"C:\text\NJ\Rowan College of South Jersey - Gloucester\2026\course_outlines.csv")
...
FOOTER_RE = re.compile(r"Course Outline[;,][^\n]+\n?", re.IGNORECASE)
