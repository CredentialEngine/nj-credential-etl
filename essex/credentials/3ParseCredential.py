...
def parse_html(directory):
    ...
    competency_csv = r"C:\text\NJ\Essex\credentials\Review\Essex_BU_Credit_Credential_Competencies.csv"
...
directory_path = r"C:\text\NJ\Essex\credentials\CredentialHTML"
