...
html_dir = r"C:\text\NJ\Atlantic Cape\noncredit\ed2go\coursesHTML"

# Output CSV file paths
courses_csv_path = r"C:\text\NJ\Atlantic Cape\noncredit\ed2go\atlanticcape_ed2go_course_BU.csv"
competencies_csv_path = r"C:\text\NJ\Atlantic Cape\noncredit\ed2go\atlanticcape_ed2go_competency_BU.csv"
        ...
        if os.path.isfile(file_path) and html_file.endswith(".html"):
            with open(file_path, 'r', encoding='utf-8') as file:
                ...
                course_row = {
                    ...
                    "Financial Assistance: Subject Webpage": "https://careertraining.atlanticcape.edu/financial-assistance/",
